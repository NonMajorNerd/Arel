...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities):
        ...
        down_stairs = Entity(center_of_last_room_x, center_of_last_room_y, 25, (102,102,153), 'Stairs',
    ...
    def place_junk(self, room, entities):
        ...
        for i in range(number_of_junks):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                new_junk = Entity(x, y, junk_char, (51,51,102), 'Junk', render_order=RenderOrder.ITEM)
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_choice == 'healing_potion':
                    ...
                    item = Entity(x, y, '!', (190,111,255), 'Healing Potion', render_order=RenderOrder.ITEM,
                                  item=item_component)
