...
class Item:
    def __init__(self, name=None, comp_name=None, use_function=None, targeting=False, targeting_message=None, stackable=False, count=1, vendor_count=1,
        description="No Description", effect="", flammable=False, ammo=None, range=0, cost=0, take_at_buy=True, **kwargs):
